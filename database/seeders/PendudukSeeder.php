        ...
        foreach ($kks as $kk) {
            ...
            for ($index = 0; $index < $anggotaCount; $index++) {
                ...
                $nik = '327312' . str_pad($day, 2, '0', STR_PAD_LEFT) .
                       ...
                       str_pad($kk->id * 10 + $index, 4, '0', STR_PAD_LEFT);
                ...
                DB::table('penduduks')->insert([
                    ...
                    'hubungan_keluarga' => $index === 0 ? 'Kepala Keluarga' : $faker->randomElement([
                        'Istri', 'Anak', 'Menantu', 'Cucu', 'Orangtua',
